import type { ConsoleFrontmatter, FeedFrontmatter, NoteFrontmatter, ProductFrontmatter } from '$lib/types';
...
const feedMods = import.meta.glob<{ metadata: FeedFrontmatter }>('/content/feed/*.md', { eager: true });
...
export const load: PageLoad = async () => {
	...
	const latestFeed = Object.values(feedMods)
