...
These terms apply to all purchases made through dexterlabs.nl.
...
All prices are displayed in euros (EUR) and are inclusive of Dutch VAT (21%) where applicable for EU consumers. Buyers outside the EU may be exempt from Dutch VAT; the applicable price is shown at checkout.

Payment is processed securely by Stripe. We accept major credit and debit cards. Your order is confirmed once payment is complete.
...
**Pre-orders:** You may cancel a pre-order and receive a full refund at any time before the item ships. Once shipped, the standard 14-day withdrawal right applies.

The withdrawal right does not apply to goods that are clearly personalised or custom-made to your specification.
...
These terms are governed by Dutch law. Disputes shall be submitted to the competent court in the district of Den Haag, unless mandatory consumer protection law provides otherwise.

## Changes

We may update these terms from time to time. The version in effect at the time of your purchase applies to that transaction.
