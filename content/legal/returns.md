...
If you are a consumer within the European Union you have a **14-day right of withdrawal** (herroepingsrecht) from the date you receive your order. You do not need to give a reason.
...
**Refund:** Once we receive and inspect the item, we will refund the full purchase price (including original standard shipping) within 14 days, using the same payment method you used to order.
...
- Items damaged by misuse, modification, or improper handling after receipt.
